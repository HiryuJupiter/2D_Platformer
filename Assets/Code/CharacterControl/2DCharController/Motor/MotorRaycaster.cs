...
//This "motor" class manages the player's physics logics
...
public class MotorRaycaster : MonoBehaviour
{
    ...
    // Get distance and angle to ground when moving by casting a diagnal line based on velocity
    ...
    // Get distance and angle to ground when not moving by casting a straight line downwards
    ...
    //Ray cast downwards from left and right feet to see if on ground
    bool OnGroundCheck()
    {
    ...
    #region Util
    //A method that handles the raycast, and also does a debug ray 
    ...
    //Gets slope angle by checking the slope normal and up direction
